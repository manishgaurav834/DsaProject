#include <iostream>
#include <cassert>
#include "student_solution.cpp" // Include the header file for your PhoneBook class
...
void testLoadContactsFromFile() {
    try {
        ...
        PhoneBook phoneBook;
        phoneBook.readRecordsFromFile("new.txt"); // Assuming the file is in the same directory
...
void test_add_and_delete_contact() {
        ...
        //phone_book -> readRecordsFromFile("new.txt");
...
//         bool one = phone_book->deleteContact(new std::string("Ankush Gupta"));
//         cout << one << endl;
//         if ( one && phone_book->deleteContact(new std::string("Aarav Khanna"))) {
